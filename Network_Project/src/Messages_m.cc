...
Messages_Base::Messages_Base(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
{
}

Messages_Base::Messages_Base(const Messages_Base& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
Messages_Base& Messages_Base::operator=(const Messages_Base& other)
{
...
void Messages_Base::copy(const Messages_Base& other)
{
...
void Messages_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void Messages_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
int Messages_Base::getSeq_Num() const
{
    return this->Seq_Num;
}

void Messages_Base::setSeq_Num(int Seq_Num)
{
    this->Seq_Num = Seq_Num;
}

int Messages_Base::getM_Type() const
{
    return this->M_Type;
}

void Messages_Base::setM_Type(int M_Type)
{
    this->M_Type = M_Type;
}

int Messages_Base::getACK_Num() const
{
    return this->ACK_Num;
}

void Messages_Base::setACK_Num(int ACK_Num)
{
    this->ACK_Num = ACK_Num;
}

int Messages_Base::getNACK_Num() const
{
    return this->NACK_Num;
}

void Messages_Base::setNACK_Num(int NACK_Num)
{
    this->NACK_Num = NACK_Num;
}

const char * Messages_Base::getM_Payload() const
{
    return this->M_Payload.c_str();
}

void Messages_Base::setM_Payload(const char * M_Payload)
{
    this->M_Payload = M_Payload;
}

const bits& Messages_Base::getTrailer() const
{
    return this->Trailer;
}

void Messages_Base::setTrailer(const bits& Trailer)
{
    this->Trailer = Trailer;
}

class MessagesDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertyNames;
    enum FieldConstants {
...
Register_ClassDescriptor(MessagesDescriptor)

MessagesDescriptor::MessagesDescriptor() : omnetpp::cClassDescriptor("Messages", "omnetpp::cPacket")
{
    propertyNames = nullptr;
}

MessagesDescriptor::~MessagesDescriptor()
{
    delete[] propertyNames;
}

bool MessagesDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<Messages_Base *>(obj)!=nullptr;
}

const char **MessagesDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
...
const char *MessagesDescriptor::getProperty(const char *propertyName) const
{
...
int MessagesDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? 6+base->getFieldCount() : 6;
}

unsigned int MessagesDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *MessagesDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int MessagesDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    ...
    if (strcmp(fieldName, "Trailer") == 0) return baseIndex + 5;
    return base ? base->findField(fieldName) : -1;
}

const char *MessagesDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char **MessagesDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *MessagesDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int MessagesDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    Messages_Base *pp = omnetpp::fromAnyPtr<Messages_Base>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void MessagesDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    Messages_Base *pp = omnetpp::fromAnyPtr<Messages_Base>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'Messages_Base'", field);
    }
}

const char *MessagesDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string MessagesDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_Trailer: return "";
        default: return "";
    }
}

void MessagesDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Messages_Base'", field);
    }
}

omnetpp::cValue MessagesDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_Trailer: return omnetpp::toAnyPtr(&pp->getTrailer()); break;
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'Messages_Base' as cValue -- field index out of range?", field);
    }
}

void MessagesDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *MessagesDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        case FIELD_Trailer: return omnetpp::opp_typename(typeid(bits));
        default: return nullptr;
    };
}

omnetpp::any_ptr MessagesDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void MessagesDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
